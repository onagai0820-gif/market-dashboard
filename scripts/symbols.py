...
GROUPS = [
    {
        ...
        "items": [
            ...
            ("td", "TOPIX", "TOPIX", "日本", "pt"),
            ("td", "DAX", "DAX", "ドイツ", "pt"),
            ("td", "UKX", "FTSE 100", "英国", "pt"),
            ("td", "HSI", "ハンセン指数", "香港", "pt"),
            ("td", "KS11", "KOSPI", "韓国", "pt"),
        ],
    },
    ...
    },
    {
        ...
        "note": "東証プライムの主要銘柄",
        "items": [
            ("td", "7203.T", "トヨタ自動車", "7203", "JPY"),
            ("td", "6758.T", "ソニーグループ", "6758", "JPY"),
            ("td", "9984.T", "ソフトバンクG", "9984", "JPY"),
            ("td", "8306.T", "三菱UFJ", "8306", "JPY"),
            ("td", "6861.T", "キーエンス", "6861", "JPY"),
            ("td", "9983.T", "ファーストリテイリング", "9983", "JPY"),
            ("td", "6501.T", "日立製作所", "6501", "JPY"),
            ("td", "8035.T", "東京エレクトロン", "8035", "JPY"),
        ],
    },
]
